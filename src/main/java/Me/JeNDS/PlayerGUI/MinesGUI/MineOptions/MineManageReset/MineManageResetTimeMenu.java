...
public class MineManageResetTimeMenu extends PFGUI {
    ...
    public MineManageResetTimeMenu(PFGUI lastMenu, Mine mine) {
        ...
        addItems(Material.EMERALD_BLOCK, DefaultColor + "Add 5 Minutes", null, 12, this);
        addItems(Material.EMERALD_BLOCK, DefaultColor + "Add 10 Minutes", null, 21, this);
        addItems(Material.EMERALD_BLOCK, DefaultColor + "Add 25 Minutes", null, 30, this);
        addItems(Material.EMERALD_BLOCK, DefaultColor + "Add 50 Minutes", null, 39, this);
        addItems(Material.REDSTONE_BLOCK, DefaultColor + "Remove 5 Minutes", null, 14, this);
        addItems(Material.REDSTONE_BLOCK, DefaultColor + "Remove 10 Minutes", null, 23, this);
        addItems(Material.REDSTONE_BLOCK, DefaultColor + "Remove 25 Minutes", null, 32, this);
        addItems(Material.REDSTONE_BLOCK, DefaultColor + "Remove 50 Minutes", null, 41, this);
        addItems(Material.REDSTONE_BLOCK, DefaultColor + "Back", null, 45, this);

        setMenuAndInterface(StandOutColor + mine.getName() + " Manage Time Reset Menu " + mine.getMineResetTime()+"M", 54, InventoryType.CHEST, true, fillItem(), PF.getInstance());
    }
